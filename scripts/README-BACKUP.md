...
```bash
nano C:\Users\11237\.openclaw-autoclaw\workspace/.env.backup
```
...
保存后设置权限：
```bash
chmod 600 C:\Users\11237\.openclaw-autoclaw\workspace/.env.backup
```

### 步骤 2：运行配置脚本

```bash
C:\Users\11237\.openclaw-autoclaw\workspace/scripts/setup-cron.sh
```
...
# 手动测试运行一次
source C:\Users\11237\.openclaw-autoclaw\workspace/.env.backup
C:\Users\11237\.openclaw-autoclaw\workspace/scripts/daily-backup.sh

# 查看日志
cat C:\Users\11237\.openclaw-autoclaw\workspace/logs/backup-$(date +%Y%m%d).log
```
