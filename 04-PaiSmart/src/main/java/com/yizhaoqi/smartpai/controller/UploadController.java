...
public class UploadController {
    ...
    @Autowired
    private UploadService uploadService;   //业务逻辑层

    @Autowired
    private KafkaTemplate<String, Object> kafkaTemplate;  //发送异步任务
    ...
    @Autowired
    private FileUploadRepository fileUploadRepository;  //数据库操作
    
    @Autowired
    private FileTypeValidationService fileTypeValidationService;    //文件类型认证
